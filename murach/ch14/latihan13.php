<?php
    ...
    // sintak 'final' untuk mencegah override dari class turunan / tidak boleh di duplikat
    ...
    abstract class Person {
        ...
        final public function getFirstName() { return $this->firstName; }
    ...
    class Employee extends Person {
        ...
        public function getFirstName() { return ucwords($this->firstName); }
